...
class TicketTestCase(BaseTestCase, JSONWebTokenTestCase):
    ...
    def test_buy_early_bird_ticket(self, mock_iamporter, mock_config):
        # Given
        self.mock_config_and_iamporter(mock_config, mock_iamporter)
    ...
    @mock.patch('ticket.schemas.config')
    @mock.patch('ticket.schemas.Iamporter', autospec=True)
    def test_buy_early_bird_ticket_foreign(self, mock_iamporter, mock_config):
        # Given
        self.mock_config_and_iamporter(mock_config, mock_iamporter)
    ...
    @mock.patch('ticket.schemas.config')
    @mock.patch('ticket.schemas.Iamporter', autospec=True)
    def test_GIVEN_카드_정보_일부_누락_buy_early_bird_ticket_foreign_THEN_에러발생(self, mock_iamporter, mock_config):
        # Given
        self.mock_config_and_iamporter(mock_config, mock_iamporter)
    ...
    def mock_config_and_iamporter(self, mock_config, mock_iamporter):
    ...
    @mock.patch('ticket.schemas.config')
    @mock.patch('ticket.schemas.Iamporter', autospec=True)
    def test_GIVEN_카드_정보_일부_누락_WHEN_buy_early_bird_ticket_THEN_에러발생1(self, mock_iamporter, mock_config):
        # Given
    ...
    @mock.patch('ticket.schemas.config')
    @mock.patch('ticket.schemas.Iamporter', autospec=True)
    def test_GIVEN_카드_정보_일부_누락_WHEN_buy_early_bird_ticket_THEN_에러발생2(self, mock_iamporter, mock_config):
        # Given
